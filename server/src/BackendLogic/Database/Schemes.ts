...
// Model definitions using define instead of classes
...
export const Version = sequelize.define('Version', Version_Model, { timestamps: false });
export const Module = sequelize.define('Module', Module_Model);
export const Issue = sequelize.define('Issue', Issue_Model);
export const UserChosenProduct = sequelize.define('UserChosenProduct', UserChosenProduct_Model);
