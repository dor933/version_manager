              ...
              {versions_to_notify.map((version) => (
                ...
                >
                  <Typography sx={{ fontSize: '12px', color: '#424242', fontFamily: 'Kumbh Sans' }}>
                    {version.is_new ? `New Version! ${version.ProductName.replace('_', '')} ${version.VersionName}` : `${version.ProductName.replace('_', '')} ${version.VersionName} is nearing end of support life`} 
